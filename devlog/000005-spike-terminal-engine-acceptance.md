...
- Directly adding upstream `wezterm-term` as a Git dependency works, but it locked 201 packages and fetched graphics/font submodules. That build cost should be treated as a packaging risk, not ignored.
...
- HEAD — test: add terminal engine acceptance spikes
